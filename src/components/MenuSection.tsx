...
export const MenuSection: React.FC<MenuSectionProps> = ({ 
  ...
  return (
    <div className="bg-white bg-opacity-95 rounded-3xl px-2 py-4 md:p-8 shadow-xl backdrop-blur-sm animate-fade-in">
          ...
          {Object.keys(displayData).map(section =>
            Object.keys(displayData[section] || {}).map(category => (
              <div
                ...
                className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-2 md:p-6 shadow-md transition-transform duration-300 hover:-translate-y-1"
              >
